...
\twocolsection{}{
  ...
  & \small\emph{EDynamique des pathogènes dans le cycle de l’eau : de l’entrée à la sortie des stations d’épuration (STEP) : analyse de l’efficacité des traitements avancés} | \small Encadrement à 15~\% - co-direction : R. \textsc{Moilleron}, M.D. \textsc{Jusselme}\\
  &\\
  %------------------------------------------------
}

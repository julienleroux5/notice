...
2024-2027 & Projet ADEME GRAINE. \emph{FreezePee} : « \emph{Procédé de congélation} ». Porteur principal, collaboration avec ENPC, Terre et Cité, INRAE. Budget total XXX k€.\\

2024-2027 & Appel EUR Live, financement de thèse acquis : « \emph{Peut-on prévoir...} ». XXX k€.\\

2024-2027 & Appel thèse région IdF, financement acquis : « \emph{ADNe} ». XXX k€.\\
}
```
...
Collaboration internationale UQAR Amina Ben Chaaben
...
Européenne)\\
  ...
  2024-2027 & Corentin \textsc{Eschenbrenner}, \textbf{post-doctorant de l'Université Paris-Est Créteil}, appel à projet ADEME GRAINE\\
  & \small\emph{Freezepee}\\
}
```
### Doctorants
...
\twocolsection{}{
  ...
  2024-2027 & Ravo \textsc{Ravaozafindrasoa}, \textbf{doctorant de l'Université Paris-Est Créteil}, EUR Live\\
  & \small\emph{Peut-on prévoir la vulnérabilité sanitaire des ressources en eau en couplant la pression chimique à l'ADN environnemental ?} | \small Co-direction : A. \textsc{Bressy}, M.D.  \textsc{Jusselme}\\
}
```
### Stagiaires
...
```{=tex}
\begin{color}{red}
(y compris jurys MCF ?) + RIPEC quelquepart ?
\end{color}
```
#### Comités de suivi
